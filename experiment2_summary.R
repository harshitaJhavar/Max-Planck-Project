...
trainTable$summarySentiment <- sentimentOutcomeTrainList
...
#Model Building
trainedModelOnNGramsOfSummary <- multinom(emotionOutcomeList ~ summarySentimentOutcomeList + trainTable$nanogram + trainTable$septagram + trainTable$pentagram + trainTable$trigram, MaxNWts = 23000)
